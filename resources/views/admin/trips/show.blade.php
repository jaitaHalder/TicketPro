                            ...
                            <table class="table table-sm">
                                ...
                                @foreach($subRoutes as $i => $subRoute)
                                    <tr>
                                        <td>
                                            <label>
                                                <select name="sub_routes[{{ $i }}][origin]" class="form-control form-control-sm" disabled>
                                                    <option value="">Choose...</option>
                                                    @foreach($busStops as $busStop)
                                                        <option value="{{ $busStop->id }}" @selected($busStop->id == $subRoute->origin)>
                                                            {{ $busStop->name }}
                                                        </option>

                                                        @break($busStop->id == $subRoute->origin)
                                                    @endforeach
                                                </select>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <select name="sub_routes[{{ $i }}][destination]" class="form-control form-control-sm" disabled>
                                                    <option value="">Choose...</option>
                                                    @foreach($busStops as $busStop)
                                                        <option value="{{ $busStop->id }}" @selected($busStop->id == $subRoute->destination)>
                                                            {{ $busStop->name }}
                                                        </option>

                                                        @break($busStop->id == $subRoute->destination)
                                                    @endforeach
                                                </select>
                                            </label>
                                        </td>
                                ...
                                @for($i = $subRoutes->count(); $i < $limit; $i++)
                                    <tr>
