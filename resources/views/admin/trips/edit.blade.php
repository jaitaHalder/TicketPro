                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <table class="table table-sm">
                                ...
                                @foreach($subRoutes as $i => $subRoute)
                                    <tr>
                                        <td>
                                            <label>
                                                <input type="hidden" name="exist_sub_routes[{{ $i }}][id]" value="{{ $subRoute->id }}">
                                                <select name="exist_sub_routes[{{ $i }}][origin]" class="form-control form-control-sm">
                                                    <option value="">Choose...</option>
                                                    @foreach($busStops as $busStop)
                                                        <option value="{{ $busStop->id }}" @selected($busStop->id == old("sub_routes.$i.origin", $subRoute->origin))>
                                                            {{ $busStop->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <td>
                                            <label>
                                                <select name="exist_sub_routes[{{ $i }}][destination]" class="form-control form-control-sm">
                                                    <option value="">Choose...</option>
                                                    @foreach($busStops as $busStop)
                                                        <option value="{{ $busStop->id }}" @selected($busStop->id == old("sub_routes.$i.destination", $subRoute->destination))>
                                                            {{ $busStop->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                ...
                                @for($i = count($subRoutes); $i < $limit; $i++)
                                    <tr>
                                        <td>
                                            <label>
                                                <select name="sub_routes[{{ $i }}][origin]" class="form-control form-control-sm">
                                                    <option value="">Choose...</option>
                                                    @foreach($busStops as $busStop)
                                                        <option value="{{ $busStop->id }}" @selected($busStop->id == old("sub_routes.$i.origin"))>
                                                            {{ $busStop->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <td>
                                            <label>
                                                <select name="sub_routes[{{ $i }}][destination]" class="form-control form-control-sm">
                                                    <option value="">Choose...</option>
                                                    @foreach($busStops as $busStop)
                                                        <option value="{{ $busStop->id }}" @selected($busStop->id == old("sub_routes.$i.origin"))>
                                                            {{ $busStop->name }}
                            ...
                            <div class="alert alert-info" role="alert">
                                <strong>Note: </strong>A maximum of {{ $limit }} sub routes are allowed. If you add origin and destination it will create sub route.
                            </div>
                        </div>
                    </div>
