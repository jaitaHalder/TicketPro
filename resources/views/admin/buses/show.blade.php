...
@section("content")
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Show Train</h1>
            <a href="{{ route("admin.buses.index") }}"
               class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    class="fas fa-eye fa-sm text-white-50"></i> Trains</a>
        </div>
            ...
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label for="bus_name" class="col-sm-3 col-form-label text-right font-weight-bold">Train Name *</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea name="detail" id="detail" class="form-control" rows="5" disabled>{{ $bus->detail }}</textarea>
                        </div>
                    </div>
